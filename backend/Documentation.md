...
##### Реализованные методы
  ...
  boardByName(name: String!, viewerId: UUID): [Board!]
  boardsByGroup(groupId: UUID!, viewerId: UUID): [Board!]

  pin(id: UUID!, viewerId: UUID): Pin
  pinsByUser(userId: UUID!, viewerId: UUID): [Pin!]
  pinsByName(name: String!, viewerId: UUID): [Pin!]
  pinsByLocation(query: String!, viewerId: UUID): [Pin!]
