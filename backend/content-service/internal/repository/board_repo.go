...
func (r *BoardRepository) GetByName(ctx context.Context, name string, viewerID *uuid.UUID) ([]models.Board, error) {
...
func (r *BoardRepository) GetByGroup(ctx context.Context, groupID uuid.UUID, viewerID *uuid.UUID) ([]models.Board, error) {
	var boards []models.Board
