...
func (r *queryResolver) Boards(ctx context.Context, viewerID *uuid.UUID, limit *int, offset *int) ([]*model.Board, error) {
	logger := zap.L().With(zap.String("resolver", "Boards"))
	logger.Info("Fetching all public boards for feed")
	...
	boards, err := r.BoardRepo.GetAllPublic(ctx, viewerID, *limit, *offset)
	if err != nil {
	...
	logger.Info("Successfully fetched all boards", zap.Int("count", len(retBoards)))
...
// Pins is the resolver for the pins field (all pins for feed).
func (r *queryResolver) Pins(ctx context.Context, viewerID *uuid.UUID, limit *int, offset *int) ([]*model.Pin, error) {
	logger := zap.L().With(zap.String("resolver", "Pins"))
	logger.Info("Fetching all pins for feed")
	...
	pins, err := r.PinRepo.GetAll(ctx, viewerID, *limit, *offset)
	if err != nil {
	...
	logger.Info("Successfully fetched all pins", zap.Int("count", len(retPins)))
	return retPins, nil
}
...
// LikedPinsByUser is the resolver for the likedPinsByUser field.
func (r *queryResolver) LikedPinsByUser(ctx context.Context, userID uuid.UUID, limit *int, offset *int) ([]*model.Pin, error) {
	logger := zap.L().With(zap.String("resolver", "LikedPinsByUser"), zap.String("userID", userID.String()))
	logger.Info("Fetching liked pins by user")
	...
	pins, err := r.PinRepo.GetLikedByUser(ctx, userID, *limit, *offset)
	if err != nil {
		logger.Error("Failed to fetch liked pins", zap.Error(err))
		return nil, err
	}
	...
	logger.Info("Successfully fetched liked pins", zap.Int("count", len(retPins)))
	return retPins, nil
}

// LikedBoardsByUser is the resolver for the likedBoardsByUser field.
func (r *queryResolver) LikedBoardsByUser(ctx context.Context, userID uuid.UUID, limit *int, offset *int) ([]*model.Board, error) {
	logger := zap.L().With(zap.String("resolver", "LikedBoardsByUser"), zap.String("userID", userID.String()))
	logger.Info("Fetching liked boards by user")
	...
	boards, err := r.BoardRepo.GetLikedByUser(ctx, userID, *limit, *offset)
	if err != nil {
		logger.Error("Failed to fetch liked boards", zap.Error(err))
		return nil, err
	}
	...
	logger.Info("Successfully fetched liked boards", zap.Int("count", len(retBoards)))
	return retBoards, nil
}

// BookmarkedPinsByUser is the resolver for the bookmarkedPinsByUser field.
func (r *queryResolver) BookmarkedPinsByUser(ctx context.Context, userID uuid.UUID, limit *int, offset *int) ([]*model.Pin, error) {
	logger := zap.L().With(zap.String("resolver", "BookmarkedPinsByUser"), zap.String("userID", userID.String()))
	logger.Info("Fetching bookmarked pins by user")
	...
	pins, err := r.PinRepo.GetBookmarkedByUser(ctx, userID, *limit, *offset)
	if err != nil {
		logger.Error("Failed to fetch bookmarked pins", zap.Error(err))
		return nil, err
	}
	...
	logger.Info("Successfully fetched bookmarked pins", zap.Int("count", len(retPins)))
	return retPins, nil
}

// BookmarkedBoardsByUser is the resolver for the bookmarkedBoardsByUser field.
func (r *queryResolver) BookmarkedBoardsByUser(ctx context.Context, userID uuid.UUID, limit *int, offset *int) ([]*model.Board, error) {
	logger := zap.L().With(zap.String("resolver", "BookmarkedBoardsByUser"), zap.String("userID", userID.String()))
	logger.Info("Fetching bookmarked boards by user")
	...
	boards, err := r.BoardRepo.GetBookmarkedByUser(ctx, userID, *limit, *offset)
	if err != nil {
		logger.Error("Failed to fetch bookmarked boards", zap.Error(err))
		return nil, err
	}
	...
	logger.Info("Successfully fetched bookmarked boards", zap.Int("count", len(retBoards)))
	return retBoards, nil
}
