...
type ComplexityRoot struct {
	...
	Query struct {
		...
		BoardByName              func(childComplexity int, name string, viewerID *uuid.UUID) int
		BoardsByGroup            func(childComplexity int, groupID uuid.UUID, viewerID *uuid.UUID) int
		...
		PinsByLocation           func(childComplexity int, query string, viewerID *uuid.UUID) int
		PinsByName               func(childComplexity int, name string, viewerID *uuid.UUID) int
		PinsByUser               func(childComplexity int, userID uuid.UUID, viewerID *uuid.UUID) int
...
type QueryResolver interface {
	...
	BoardByName(ctx context.Context, name string, viewerID *uuid.UUID) ([]*model.Board, error)
	BoardsByGroup(ctx context.Context, groupID uuid.UUID, viewerID *uuid.UUID) ([]*model.Board, error)
	Pin(ctx context.Context, id uuid.UUID, viewerID *uuid.UUID) (*model.Pin, error)
	PinsByUser(ctx context.Context, userID uuid.UUID, viewerID *uuid.UUID) ([]*model.Pin, error)
	PinsByName(ctx context.Context, name string, viewerID *uuid.UUID) ([]*model.Pin, error)
	PinsByLocation(ctx context.Context, query string, viewerID *uuid.UUID) ([]*model.Pin, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.boardByName":
		...
		return e.complexity.Query.BoardByName(childComplexity, args["name"].(string), args["viewerId"].(*uuid.UUID)), true
	...
	case "Query.boardsByGroup":
		...
		return e.complexity.Query.BoardsByGroup(childComplexity, args["groupId"].(uuid.UUID), args["viewerId"].(*uuid.UUID)), true
	...
	case "Query.pinsByLocation":
		...
		return e.complexity.Query.PinsByLocation(childComplexity, args["query"].(string), args["viewerId"].(*uuid.UUID)), true
	...
	case "Query.pinsByName":
		...
		return e.complexity.Query.PinsByName(childComplexity, args["name"].(string), args["viewerId"].(*uuid.UUID)), true
	...
	case "Query.pinsByUser":
		...
		return e.complexity.Query.PinsByUser(childComplexity, args["userId"].(uuid.UUID), args["viewerId"].(*uuid.UUID)), true
...
func (ec *executionContext) _Query_boardByName(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().BoardByName(rctx, fc.Args["name"].(string), fc.Args["viewerId"].(*uuid.UUID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_boardsByGroup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().BoardsByGroup(rctx, fc.Args["groupId"].(uuid.UUID), fc.Args["viewerId"].(*uuid.UUID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_pinsByUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().PinsByUser(rctx, fc.Args["userId"].(uuid.UUID), fc.Args["viewerId"].(*uuid.UUID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_pinsByName(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().PinsByName(rctx, fc.Args["name"].(string), fc.Args["viewerId"].(*uuid.UUID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_pinsByLocation(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().PinsByLocation(rctx, fc.Args["query"].(string), fc.Args["viewerId"].(*uuid.UUID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
